...
def example_5_10_15():
    ...
    #?
    table_player = PlayerChooser(SelectPlayer.TablePlayer, table_type)
    player = PlayerChooser(SelectPlayer.EachPlayer, player_type)
    ...
    firstPlayer = PlayerChooser(SelectPlayer.FirstPlayer, player_type)
    #nextPlayer = lambda players_list, current_index: (current_index + 1) % len(players_list)
    nextPlayer = PlayerChooser(SelectPlayer.NextPlayer, player_type)
    ...
    current_player = PlayerChooser(SelectPlayer.CurrentPlayer, player_type)
